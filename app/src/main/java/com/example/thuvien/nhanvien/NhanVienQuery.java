...
public class NhanVienQuery {
    ...
    public List<NhanVien> timKiemNhanVien(String keyword) {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT MaNV, TenNV, QueQuan, GioiTinh, NamSinh, VaiTro, Email, Sdt, User, Pass FROM nhanvien " +
                        "WHERE MaNV LIKE ? OR TenNV LIKE ? OR User LIKE ? OR Sdt LIKE ? ORDER BY MaNV ASC",
